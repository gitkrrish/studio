...
export const issues: Issue[] = [
  {
    id: 'ISS-001',
    title: 'Major Pothole on Civil Lines Road',
    description: 'A very large and dangerous pothole has formed in the middle of Civil Lines road, near the main market. It has already caused damage to several vehicles. Needs immediate attention.',
    category: 'Roads & Highways',
    status: 'In Progress',
    priority: 'Urgent',
    location: { address: 'Civil Lines, Sagar, MP', lat: 23.839, lng: 78.74 },
  ...
  },
  {
    ...
    description: 'Someone has spray-painted graffiti all over the new mural at Lakha Banjara Park. It\'s a shame to see it defaced so quickly.',
    category: 'Parks & Recreation',
    status: 'Reported',
    priority: 'Medium',
    location: { address: 'Lakha Banjara Park, Sagar, MP', lat: 23.835, lng: 78.73 },
  ...
  {
    id: 'ISS-003',
    title: 'Trash cans overflowing at Teen Batti',
    description: 'All the public trash cans in the Teen Batti area are completely full and overflowing. It\'s creating a mess and attracting pests.',
    category: 'Sanitation',
    status: 'Resolved',
    priority: 'High',
    location: { address: 'Teen Batti, Sagar, MP', lat: 23.84, lng: 78.75 },
  ...
  {
    id: 'ISS-004',
    title: 'Broken Streetlight in Tilli',
    description: 'The streetlight at the corner of Tilli Ward has been out for three nights. It\'s very dark and feels unsafe.',
    category: 'Public Safety',
    status: 'Reported',
    priority: 'High',
    location: { address: 'Tilli, Sagar, MP', lat: 23.83, lng: 78.72 },
  ...
  {
    id: 'ISS-005',
    title: 'Water main break in Sadar Bazaar',
    description: 'There appears to be a water main break in Sadar Bazaar. Water is bubbling up from the pavement and running down the gutter.',
    category: 'Water & Sewage',
    status: 'In Progress',
    priority: 'Urgent',
    location: { address: 'Sadar Bazaar, Sagar, MP', lat: 23.85, lng: 78.76 },
  ...
  },
  {
    ...
    description: 'One of the swings at the Bhagyoday Tirth playground is broken and hanging by a single chain. It\'s a safety hazard for children.',
    category: 'Parks & Recreation',
    status: 'Resolved',
    priority: 'Medium',
    location: { address: 'Bhagyoday Tirth, Sagar, MP', lat: 23.82, lng: 78.71 },
